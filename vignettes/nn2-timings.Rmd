...
Read in some public data and prepare a sample of 500 neurons with XYZ coordinates
```{r, eval=FALSE}
...
OK now we're going to use that canned sample
```{r, eval=runv}
...
Define a utility function borrowed from the nat.nblast package:
