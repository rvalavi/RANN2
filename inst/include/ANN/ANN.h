...
#ifndef ANN_COORD_TYPE
  #define ANN_COORD_TYPE double
#endif
typedef ANN_COORD_TYPE ANNcoord;

// distance data type
#ifndef ANN_DIST_TYPE
  #define ANN_DIST_TYPE double
#endif
typedef ANN_DIST_TYPE ANNdist;
